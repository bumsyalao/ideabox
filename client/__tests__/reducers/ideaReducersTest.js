...
import { loadIdeas, loadUserIdeas, loadSearchIdeas, loadIdeaSuccess } from '../../actions/ideaAction';
...
const foundIdeas = [
  {
    ...
    __v: 2,
    comments: [
      '5a3246c980a9f383d543bb60'
    ],
    modified: true
  },
];
describe('load ideas reducer', () => {
  it('should dispatch login a user when authentictaion is succesful', () => {
